...
%% Parameters
% Prompt user input
prompt = {'Enter frames threshold:','Enter time threshold:','Enter fitting percentage:'};
...
% PArameters
partitles = {'Frames';'Time';'Fitting';'dT';'VelocityLower';'VelocityHigher';'CriticalAngle'};
patvals = [framesthresh;timethresh;fit_perc;dT;lowvelthresh;upvelthresh;critangle];
finalparameters = table(partitles,patvals);
writetable(finalparameters,fullFileName,'Sheet','Parameters')
